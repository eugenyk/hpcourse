...
@JCStressTest
@Description("Check that add operation works correctly")
@Outcome(id = "true", expect = Expect.ACCEPTABLE, desc = "Addition from 3 workers is correct")
@Outcome(id = "false", expect = Expect.FORBIDDEN, desc = "Addition from 3 workers is incorrect")
@State
public class LockFreeAdd {
    ...
    private AtomicInteger totalAdded = new AtomicInteger(0);
    ...
    public void checkResult(L_Result result) {
        result.r1 = totalAdded.get() == TOTAL_NUMBERS;
    }
