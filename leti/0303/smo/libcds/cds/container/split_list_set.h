...
#       endif
        ...
        */
        ...
        {
            return base_class::extract_( dest.guard(), key, typename base_class::key_comparator() );
        }
        ...
        */
        ...
        {
            return base_class::extract_( dest.guard(), key, typename maker::template predicate_wrapper<Less>::type() ) ;
        }
        ...
        */
        ...
        {
            return base_class::get_( ptr.guard(), val, key_comparator() )  ;
        }

        /// Finds the key \p val and return the item found
        /**
            The function is an analog of \ref cds_nonintrusive_SplitListSet_hp_get "get( guarded_ptr& ptr, Q const&)"
        ...
        */
        ...
        {
            return base_class::get_( ptr.guard(), val, typename maker::template predicate_wrapper<Less>::type() )  ;
        }
