...
#       endif
        ...
        /** \anchor cds_nonintrusive_SkipListMap_rcu_extract
            ...
            // ...
            {
                ...
                skip_list::value_type * pVal = theList.extract( 5 );
                // Deal with pVal
                //...
        ...
        */
        template <typename K>
        value_type * extract( K const& key )
        {
        ...
        /**
            The function is an analog of \ref cds_nonintrusive_SkipListMap_rcu_extract "extract(K const&)"
        ...
        */
        template <typename K, typename Less>
        value_type * extract_with( K const& key, Less pred )
        {
        ...
        /** 
            ...
            // ...
            {
                ...
                skip_list::value_type * pMin = theList.extract_min();
                // Deal with pMin
                //...
        ...
        */
        ...
        /// Extracts an item with minimal key from the map
        /** \anchor cds_nonintrusive_SkipListMap_hp_extract_min
            The function searches an item with minimal key, unlinks it from the map, 
...
#       endif
        ...
        /** 
            The function searches an item with maximal key, unlinks it from the map, and returns the item found.
            If the skip-list is empty the function returns \p NULL.
            ...
            // ...
            {
                ...
                skip_list::value_type * pMax = theList.extract_max();
                // Deal with pMax
                //...
        ...
        */
        ...
        /// Extracts an item with maximal key from the map
        /** \anchor cds_nonintrusive_SkipListMap_hp_extract_max
            The function searches an item with maximal key, unlinks it from the map, 
            and copy it to \p dest by \p fnCopy functor.
            The functor \p Func has the following interface:
            \code
            struct copy_functor {
        ...
        */
        ...
        /** 
            ...
            // ...
            {
                ...
                skip_list::value_type * pMin = theList.get_min();
                if ( pMin ) {
                    // Deal with pMin
                    //...
                }
        ...
        */
        ...
        /** 
            ...
            // ...
            {
                ...
                skip_list::value_type * pMax = theList.get_max();
                if ( pMax ) {
                    // Deal with pMax
                    //...
                }
