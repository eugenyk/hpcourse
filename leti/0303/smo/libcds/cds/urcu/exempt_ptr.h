...
namespace cds { namespace urcu {
    ...
    /**
        ...
        For non-intrusive containers from cds::container namespace \p Disposer is an invocation 
        of node deallocator. For intrusive containers it can be empty or it can trigger an event "node can be reused safely".
    ...
    */
    ...
    public:
        ...
        /// Dereference operator. Should be called only inside of RCU critical section
        ...
        /// Returns a reference to the value. Should be called only inside of RCU critical section
