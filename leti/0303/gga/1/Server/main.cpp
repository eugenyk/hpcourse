...
int main(int argc, char** argv)
{
    ...
    parser.setApplicationDescription("Gleb Gusachenko");
        ...
        else if(!threadCountStr.isEmpty())
        {
            ...
            else
            {
                if(parser.isSet(bigEndianOption))
                {
                    ...
                    Socket_Handler::setEndian(QSysInfo::BigEndian);
                }
                else if(parser.isSet(littleEndianOption))
                {
                    ...
                    Socket_Handler::setEndian(QSysInfo::LittleEndian);
                }
            }
        }
    }
